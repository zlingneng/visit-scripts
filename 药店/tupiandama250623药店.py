    ...
    for image_file in image_files:
        try:
            ...
            if photo_name_without_ext in data_dict:  # 判断该图片名称是否在Excel数据字典中有对应记录
                ...
                watermark_text = "水印相机"
                watermark_font_size = int(height * 0.07)  # 字体大小为图片高度的3%
...
excel_file_path = r'/Users/a000/Downloads/2504何勇/贵州药店拜访2504何勇.xlsx'
image_folder = r'/Users/a000/Downloads/2504何勇'
image_folderout = r'/Users/a000/Downloads/2504何勇/照片2'
