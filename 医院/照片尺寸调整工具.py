...
# 配置参数 - 请根据实际需要修改这些参数
SOURCE_DIR = "/Users/a000/Documents/济生/医院拜访25/2512/贵州医生拜访251201-20张令能余荷英/贵州医生拜访251201-20-张令能/照片2"  # 源照片目录
OUTPUT_DIR = "/Users/a000/Documents/济生/医院拜访25/2512/贵州医生拜访251201-20张令能余荷英/贵州医生拜访251201-20-张令能/照片3"  # 输出目录
    ...
    try:
        ...
        with Image.open(image_path) as img:
            ...
            if original_width > original_height:
                ...
                print(f"  缩放类型: 横版 -> 宽度缩放到{RESIZE_LONG_EDGE}px")
            elif original_width < original_height:
                # 长<宽（竖版）：将高度缩放到目标值
                new_height = RESIZE_SHORT_EDGE
                new_width = int(original_width * (RESIZE_SHORT_EDGE / original_height))
                print(f"  缩放类型: 竖版 -> 高度缩放到{RESIZE_SHORT_EDGE}px")
            else:
                # 正方形图片：使用长边规则
                new_width = RESIZE_LONG_EDGE
            ...
            # 保存图片 - 提高质量参数以保持清晰度
            resized_img.save(output_path, 'JPEG', quality=95, optimize=True, progressive=True)
